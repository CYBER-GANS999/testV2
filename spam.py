...
for max in range(mex):
	req = request.Request(
		...
		'https://www.olx.co.id/api/auth/authenticate/?phone='+nomor+'&old_phone='+nomor, method="POST"
		'https://api.pizzahut.co.id/customer/v1/customer/register/?phone='+nomor+'&old_phone='+nomor, method="POST"
